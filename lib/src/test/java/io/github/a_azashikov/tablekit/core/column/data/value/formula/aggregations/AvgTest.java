...
class AvgTest {
    ...
    void shouldReturnArguments_whenConstructedWithVarargs() {
        var arg1 = new Val<>(1);
        var arg2 = new Val<>(2);
        var avg = new Avg(arg1, arg2);
        assertEquals(2, avg.getArguments().size());
        assertTrue(avg.getArguments().containsAll(List.of(arg1, arg2)));
    }
    ...
    void shouldReturnArguments_whenConstructedWithCollection() {
        var arg1 = new Val<>(1);
        var arg2 = new Val<>(2);
        var avg = new Avg(List.of(arg1, arg2));
        assertEquals(2, avg.getArguments().size());
        assertTrue(avg.getArguments().containsAll(List.of(arg1, arg2)));
    }
    ...
    void shouldCallVisitorVisit_whenAcceptCalled() {
        var avg = new Avg(new Val<>(1), new Val<>(2));
        var result = avg.accept(new FormulaBaseVisitor<String>() {
            @Override
